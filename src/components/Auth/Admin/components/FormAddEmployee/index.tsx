...
import { authGetAllAccount, authRegister } from "../../../../../redux/auth/authThunk";
...
function FormAddEmployee({ setShow, initialData, actionType, currentPage, selectOption }: Props) {
  ...
  const onSubmit: SubmitHandler<InitialRegisterState> = async (formValue) => {
    dispatch(authRegister({ ...formValue, password: "Mystore123@", callBack }));
  };
