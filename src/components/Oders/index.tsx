      ...
      <div className='col-span-1 '>
        <div className='bg-white p-3 rounded-sm'>
          <div className='grid grid-cols-2 gap-3 pb-3'>
            <div className='border rounded-lg p-5'>
              <img
                ...
                src='https://cdn.tgdd.vn/Products/Images/42/114115/iphone-x-64gb-bac-org.png'
                alt=''
              />
            </div>
            <div className=''>
          ...
          <div className='grid grid-cols-2 border-t pt-3'>
            ...
            <span>Tạm tính: 900.000.000 đ</span>
          </div>
        </div>
      ...
      <div className='col-span-1 rounded-sm  bg-white p-3'>
        ...
        <div className='flex justify-between border-b text-white py-5'>
          <Button
            ...
            className='bg-corlorButton px-3 py-1 rounded-md flex items-center'
          >
            <PlusIcon className='w-5 h-5' />
            <span>Thêm địa chỉ mới</span>
          </Button>
          <Link to='/thong-tin-tai-khoan'>
            <Button className='bg-colorPrimary px-3 py-1 rounded-md'>
              Thiết lập địa chỉ
            </Button>
          </Link>
        </div>
          ...
          addressAcc.map((address) => {
            return (
              <div className='border-b py-5'>
                ...
                <p>
                  {address.detail_address},{address.province},{address.district}
                  ,{address.wards}
                </p>
              </div>
            );
        ...
        {addressAcc.length === 0 && (
          <div className='text-colorRed text-center'>
